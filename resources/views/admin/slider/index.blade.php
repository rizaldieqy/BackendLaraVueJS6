                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="{{ $slider->image }}" class="rounded" style="width:200px"></td>
                                            <td>{{ $slider->link }}</td>
                                            <td class="text-center"><button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $slider->id }}"><i class="fa fa-trash"></i></button></td>
                                        </tr>
                                        @empty
