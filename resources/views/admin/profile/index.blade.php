    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-success alert-dismissible show fade">
                ...
                @if(session('status')=='profile-information-update')
    ...
    <div class="row">
        ...
        <div class="col-md-5 mb-5">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    @if(session('status') == 'two-factor-authentication-enabled')
                    <p>Otentikasi dua faktor sekarang diaktifkan. Pindai kode QR berikut menggunakan aplikasi pengauntetikasi ponsel</p>
                    ...
                    <p>Simpan Recovery Code ini dengan aman. Ini dapat digunakan untuk memulihkan akses ke akun jika perangkat</p>
        ...
        <div class="col-md-7">
            ...
            <div class="card border-0 shadow mt-3 mb-4">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-block"></i>UPDATE PASSWORD</h6>
                </div>
